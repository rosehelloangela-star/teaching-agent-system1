...
// // export const API_BASE_URL = 'http://121.14.82.109:8061/api/v1';
...
// // export const fetchTeacherProjectConversations = async (teacherId, query = '') => {
// //   try {
// //     const response = await api.get('/conversations/teacher/projects', {
// //       params: { teacher_id: teacherId, query },
// //     });
// //     return response.data;
// //   } catch (error) {
// //     console.error('拉取教师项目会话列表失败:', error);
// //     throw error;
// //   }
// // };
...
// // export const uploadConversationAttachment = async (file) => {
// //   const formData = new FormData();
// //   formData.append('file', file.raw ?? file);
// //   try {
// //     const response = await api.post('/conversations/attachments/upload', formData, {
// //       headers: { 'Content-Type': 'multipart/form-data' },
// //     });
// //     return response.data;
// //   } catch (error) {
// //     console.error('上传教师附件失败:', error);
// //     throw error;
// //   }
// // };
// // export const fetchTeacherConversationDetail = async (conversationId, teacherId) => {
// //   try {
// //     const response = await api.get(`/conversations/teacher/projects/${conversationId}`, {
// //       params: { teacher_id: teacherId },
// //     });
// //     return response.data;
// //   } catch (error) {
// //     console.error('拉取教师项目会话详情失败:', error);
// //     throw error;
// //   }
// // };
...
// export const generateProjectStageDraft = async (conversationId, stageId) => {
//   try {
//     const response = await api.post('/agent/project-stage-draft', {
//       conversation_id: conversationId,
//       stage_id: stageId,
//     });
//     return response.data;
//   } catch (error) {
//     console.error('生成阶段优化稿失败:', error);
//     throw error;
//   }
// };
...
export const exportFinalProjectBookStream = async (conversationId, onEvent) => {
  const response = await fetch(`${API_BASE_URL}/agent/project-final-export/stream`, {
    method: 'POST',
    headers: {
  ...
  const processBuffer = async (chunkText) => {
    buffer += chunkText;
    ...
    for (const block of parts) {
      ...
      try {
        ...
        if (event.type === 'error') {
          streamError = new Error(event.message || '最终优化项目书导出失败');
        }
      } catch (e) {
        console.error('最终优化项目书流式事件解析失败:', e, block);
      }
    }
  };
