  ...
  return (
    <div className="flex-1 min-h-0 flex overflow-hidden bg-slate-50">
      ...
      <div className="flex-1 min-w-0 min-h-0 flex overflow-hidden bg-slate-50">
        ...
        <div
          className={`${reportPanelOpen ? 'w-[360px] basis-[360px]' : 'w-14 basis-14'} flex h-full flex-col shrink-0 min-w-0 min-h-0 overflow-hidden bg-white border-l border-slate-200 transition-all duration-200`}
        >
          {reportPanelOpen ? (
            <>
