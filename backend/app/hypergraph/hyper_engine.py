...
class HypergraphEngine:
    ...
    def run_topology_diagnostics(self) -> List[Dict[str, Any]]:
        ...
        # R5: 核心要素缺失比率 (放宽：从 0.6 下调到 0.4)
        if core_nodes and len(core_nodes) < len(self.expected_hyperedges["Core_Business_Loop"]) * 0.4:
