...
PUBLIC_WELFARE_STAGE_DEFINITIONS: List[Dict[str, object]] = [
    {
        ...
        "pass_threshold": 90,
        "max_critical_carryover": 0,
        "anchor_min_groups": 3,
        "rule_ids": ["PR1", "PR2", "PR3", "PR4", "PR5"],
        "guardrail_rule_ids": ["System", "PR1", "PR3", "PR5"],
        "anchor_groups": [
            {"label": "受益对象", "keys": ["Beneficiary_Group", "Service_Scenario"], "min_hits": 2},
            {"label": "需求证据", "keys": ["Problem_Severity", "Research_Sample", "Field_Observation", "Needs_Quote"], "min_hits": 2},
            {"label": "干预方案", "keys": ["Intervention_Solution", "Expected_Outcome", "Core_Service", "Trust_Mechanism"], "min_hits": 2},
        ],
    ...
    },
    {
        ...
        "anchor_groups": [
            {"label": "筹资/造血", "keys": ["Funding_Source", "Donation_Product", "Grant_Channel", "Revenue_Supplement"], "min_hits": 2},
            {"label": "影响评估", "keys": ["Impact_Goal", "Indicator_System", "Baseline_Data", "Evaluation_Method"], "min_hits": 2},
            {"label": "成本与信任", "keys": ["Single_Service_Cost", "Fund_Use_Ratio", "Financial_Disclosure", "Third_Party_Endorsement"], "min_hits": 2},
        ],
    ...
    },
    {
        ...
        "anchor_groups": [
            {"label": "复制与扩散", "keys": ["Pilot_Site", "Pilot_Result", "Replication_Condition", "Expansion_Path"], "min_hits": 2},
            {"label": "运营与资源", "keys": ["Volunteer_Role", "Training_Process", "Key_Resource", "Risk_Buffer"], "min_hits": 2},
            {"label": "合规与共创", "keys": ["Policy_Basis", "Qualification_Requirement", "Enterprise_Partner", "CoCreation_Mode", "Longterm_Mechanism"], "min_hits": 2},
        ],
